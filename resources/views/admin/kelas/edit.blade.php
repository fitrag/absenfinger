    ...
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-slate-400 mt-1">Perbarui informasi kelas {{ $kelas->nm_kls }}</p>
            </div>
        </div>
        ...
        <form action="{{ route('admin.kelas.update', $kelas) }}" method="POST"
            ...
            <div>
                ...
                <input type="text" id="nm_kls" name="nm_kls" value="{{ old('nm_kls', $kelas->nm_kls) }}" maxlength="15"
            ...
            <div>
                ...
                <input type="text" id="alias" name="alias" value="{{ old('alias', $kelas->alias) }}" maxlength="6"
