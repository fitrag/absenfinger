    ...
    <div class="space-y-6" x-data="{ showPrintModal: false }">
        ...
        <div class="bg-slate-900/50 backdrop-blur-xl border border-slate-800/50 rounded-2xl p-4 sm:p-6">
            <div class="flex flex-col gap-6">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        <h2 class="text-xl font-bold text-white">Data Absensi Siswa PKL</h2>
                ...
                <!-- Filters -->
                <form action="{{ route('admin.pkl.absensi') }}" method="GET"
                    class="flex flex-col sm:flex-row gap-4 pt-4 border-t border-slate-800/50 flex-wrap">
                    ...
                    <!-- DUDI Filter -->
                    <div class="w-full sm:w-48">
                        <label class="block text-xs text-slate-400 mb-1">Tempat PKL</label>
                    ...
                    <div class="relative flex-1">
                        ...
                        <svg class="w-5 h-5 text-slate-500 absolute left-4 top-9" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <div class="relative" x-data="{ open: false }">
                                                ...
                                                <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                                    ...
                                                    style="display: none;">
                                                    <form action="{{ route('admin.pkl.absensi.update_status') }}" method="POST">
                                                        @csrf
                ...
                <div class="bg-slate-900/50 backdrop-blur-xl border border-slate-800/50 rounded-2xl p-12 text-center">
                    <div class="flex flex-col items-center justify-center">
                        ...
                        <p class="text-xs text-slate-400 max-w-sm mx-auto">
                            Belum ada siswa PKL yang ditemukan untuk filter yang dipilih.
                        </p>
                    </div>
                </div>
            @endforelse
        ...
        <div x-show="showPrintModal" x-cloak
            ...
            <div @click.outside="showPrintModal = false"
                ...
                <!-- Modal Body -->
                <form action="{{ route('admin.pkl.absensi.print') }}" method="GET" target="_blank" class="p-5 space-y-5">
