...
@section('content')
    <div class="space-y-6" x-data="{ showModal: false }">
        ...
        <div class="flex items-center justify-between">
            <form action="{{ route('admin.users.siswa') }}" method="GET" class="flex items-center gap-3">
                ...
                <div class="relative w-64">
                    ...
                    @if(request('search'))
                        <a href="{{ route('admin.users.siswa', ['perPage' => request('perPage')]) }}" class="absolute inset-y-0 right-0 pr-2 flex items-center">
            ...
            <div class="flex items-center gap-3">
                ...
                <select class="px-3 py-2 text-sm bg-slate-900/50 border border-slate-800/50 rounded-lg text-white focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/50"
                        onchange="window.location.href='{{ route('admin.users.siswa') }}?perPage=' + this.value + '&search={{ request('search') }}'">
