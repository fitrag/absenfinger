                ...
                <div
                    ...
                    <div x-show="open" x-collapse class="mt-1 ml-4 space-y-1">
                        ...
                        <a href="{{ url('/admin/pkl') }}"
                            class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 cursor-pointer
                                                                                      {{ request()->is('admin/pkl') || (request()->is('admin/pkl/*') && !request()->is('admin/pkl/komponen-nilai*') && !request()->is('admin/pkl/nilai*')) ? 'bg-blue-500/10 text-blue-400 border border-blue-500/20' : 'text-slate-400 hover:text-white hover:bg-slate-800/50' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
