...
class SoalUsController extends Controller
{
    public function index(Request $request)
    {
        $query = SoalUs::with(['mapel', 'guru', 'tahunPelajaran', 'fileSoal']);
        ...
        $fileSoals = FileSoal::where('jenis', 'US')->get();

        return view('admin.soal.soal-us.index', compact(
            'soals',
            'mapels',
            'tahunPelajarans',
            'fileSoals',
    ...
    public function store(Request $request)
    {
        ...
        return back()->with('success', 'Soal US berhasil ditambahkan.');
    }

    public function update(Request $request, $id)
    {
        $soal = SoalUs::findOrFail($id);
        ...
        return back()->with('success', 'Soal US berhasil diupdate.');
    }
    ...
    public function destroy($id)
    {
        ...
        return back()->with('success', 'Soal US berhasil dihapus.');
    }
}
