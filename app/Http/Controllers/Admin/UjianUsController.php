...
class UjianUsController extends Controller
{
    public function index(Request $request)
    {
        $query = UjianUs::with(['mapel', 'guru', 'tahunPelajaran']);
        ...
        return view('admin.soal.ujian-us.index', compact(
            'ujians',
            'mapels',
            'tahunPelajarans',
            'activeTp'
    ...
    public function store(Request $request)
    {
        ...
        return back()->with('success', 'Ujian US berhasil ditambahkan.');
    }

    public function update(Request $request, $id)
    {
        $ujian = UjianUs::findOrFail($id);
        ...
        return back()->with('success', 'Ujian US berhasil diupdate.');
    }
    ...
    public function destroy($id)
    {
        ...
        return back()->with('success', 'Ujian US berhasil dihapus.');
    }
